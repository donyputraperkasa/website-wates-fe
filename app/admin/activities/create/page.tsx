...
export default function CreateActivityPage() {
    ...
    return (
        ...
        <div className="max-w-4xl mx-auto space-y-8 relative">
            ...
            <div>
                <h1 className="text-3xl font-bold text-gray-800">Create Activity</h1>
            ...
            <div className="space-y-2">
                <label className="text-sm font-semibold text-gray-700">Judul Aktivitas</label>
                <input
                type="text"
                value={title}
            ...
            <div className="space-y-3 border border-dashed border-gray-300 rounded-xl p-4 bg-gray-50">
                <label className="text-sm font-semibold text-gray-700">Add Image</label>
